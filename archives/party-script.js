const THIS_GENRE = "Party", PREFIX = "party";
...
function playTrack(trackId, btnElement) {
    const scUrl = `https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/${trackId}&color=%23bc13fe&auto_play=true&hide_related=true&show_comments=false`;
