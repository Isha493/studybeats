const THIS_GENRE = "Soothing", PREFIX = "soothing";
...
function playTrack(trackId, btnElement) {
    const scUrl = `https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/${trackId}&color=%230077b6&auto_play=true&hide_related=true&show_comments=false`;
